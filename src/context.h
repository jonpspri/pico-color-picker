...
static inline void context_builder_set_red_re(
    context_callback_f re_callback, void *re_data, context_callback_f button_callback, void *button_data, const char *label)
{
  context_builder_set_re(RE_RED_OFFSET, BUTTON_RED_OFFSET, re_callback, re_data, button_callback, button_data, label);
}
static inline void context_builder_set_green_re(
    context_callback_f re_callback, void *re_data, context_callback_f button_callback, void *button_data, const char *label)
{
  context_builder_set_re(RE_GREEN_OFFSET, BUTTON_GREEN_OFFSET, re_callback, re_data, button_callback, button_data, label);
}
static inline void context_builder_set_blue_re(
    context_callback_f re_callback, void *re_data, context_callback_f button_callback, void *button_data, const char *label)
{
  context_builder_set_re(RE_BLUE_OFFSET, BUTTON_BLUE_OFFSET, re_callback, re_data, button_callback, button_data, label);
}

void context_builder_set_button(uint8_t offset, context_callback_f callback, void *data, int16_t label);
static inline void context_builder_set_upper_button(context_callback_f callback, void *data, int16_t label) {
  context_builder_set_button(BUTTON_UPPER_OFFSET, callback, data, label);
}
static inline void context_builder_set_lower_button(context_callback_f callback, void *data, int16_t label) {
